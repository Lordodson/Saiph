...
void ExitState::Init()
{
	//ensured numbers were floats where floats are required
	//add BaseObject *  ? Causes memory issue on delete
...
unsigned int ExitState::Heartbeat(float _delta)
{
	...
	//changed VK_RETURN to 0x0 to match def...
